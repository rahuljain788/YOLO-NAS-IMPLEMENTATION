...
cap = cv2.VideoCapture("../videos/VehiclesEnteringandLeaving.mp4")
...
while True:
    ...
    if ret:
        ...
        #cv2.putText(frame, str("Vehicle Entering") + ":" + str(len(totalcountup)), (1317, 91), cv2.FONT_HERSHEY_PLAIN,
        # 0, 1, (255, 255,255), 2)
        #cv2.putText(frame, str("Vehicle Leaving") + ":" + str(len(totalcountdown)), (141, 91), cv2.FONT_HERSHEY_PLAIN,
        # 0, 1, (255, 255, 255), 2)
        cv2.rectangle(frame, (1267, 65), (1617, 97), [255, 0, 255], -1, cv2.LINE_AA)
        cv2.putText(frame, str("Vehicle Entering") + ":" + str(len(totalcountup)), (1317, 91), 0, 1, [225, 255, 255],
                    thickness=2, lineType=cv2.LINE_AA)
        cv2.rectangle(frame, (100, 65), (441, 97), [255, 0, 255], -1, cv2.LINE_AA)
        cv2.putText(frame, str("Vehicle Leaving") + ":" + str(len(totalcountdown)), (141, 91), 0, 1, [225, 255, 255],
                    thickness=2, lineType=cv2.LINE_AA)
